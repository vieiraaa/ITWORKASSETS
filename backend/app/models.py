...
class MetricSnapshot(Base):
    ...
    cpu_frequency_max_mhz: Mapped[float | None] = mapped_column()
    cpu_model: Mapped[str | None] = mapped_column(String(255))
    cpu_logical_count: Mapped[int | None] = mapped_column()
    cpu_physical_count: Mapped[int | None] = mapped_column()
    ram_percent: Mapped[float | None] = mapped_column()
    ram_used_mb: Mapped[float | None] = mapped_column()
    ram_total_mb: Mapped[float | None] = mapped_column()
    gpu_percent: Mapped[float | None] = mapped_column()
    gpu_memory_used_mb: Mapped[float | None] = mapped_column()
    gpu_memory_total_mb: Mapped[float | None] = mapped_column()
